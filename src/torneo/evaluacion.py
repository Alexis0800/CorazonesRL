...
__all__ = [
    ...
    "_PoliticaSnapshot", "evaluar_contra_snapshots",
...
if __name__ == "__main__":
    ...
    if args.elo:
        from src.torneo.elo import torneo_elo
        ...
        print("=" * 60)
        print(
            f"{'Pos':<5} {'Snapshot':<30} {'Origen':<8} {'Paso':<12} {'Elo':<8} {'Δ'}")
        print("-" * 60)
    ...
    b = resultado["bots"]
    print(
        f"  🥇 1º: {b['pct_primero']:.1%} | 🥈 2º: {b['pct_segundo']:.1%}")
    print(
        f"  📊 Top-2: {b['pct_top2']:.1%} | 💀 4º: {b['pct_cuarto']:.1%}")
