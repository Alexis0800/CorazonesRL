...
class Jugador:
    ...
    def recibir_mano(self, cartas: List[Carta]) -> None:
        ...
        Args:
            cartas: Lista de 13 cartas repartidas por la baraja.
        """
    ...
    def jugar_carta(self, carta: Carta) -> Carta:
        ...
        Args:
            carta: La carta a jugar.

        Returns:
            La carta jugada.

        Raises:
            ValueError: Si la carta no está en la mano del jugador.
        """
        try:
    ...
    def sumar_puntos(self, puntos: int) -> None:
        ...
        Args:
            puntos: Cantidad de puntos a sumar.
        """
    ...
    def contar_puntos_bazas(self) -> int:
        ...
        Returns:
            Suma de puntos de todas las cartas en bazas_ganadas.
        """
