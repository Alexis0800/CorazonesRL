...
class TestEvaluarContraBots:
    ...
    def test_metricas_tiene_keys_esperadas(self):
        ...
        from src.torneo.evaluacion import _construir_metricas
...
class TestEscenariosEstrategicos:
    ...
    def test_escenario_q_spades_sin_pozo_existe(self):
        ...
        from src.torneo.evaluacion import _crear_escenario_q_spades_sin_pozo
    ...
    def test_escenario_pozo_viable_existe(self):
        ...
        from src.torneo.evaluacion import _crear_escenario_pozo_viable
    ...
    def test_evaluar_escenario_retorna_metricas(self):
        ...
        from src.torneo.evaluacion import evaluar_escenario, _crear_escenario_q_spades_sin_pozo
        from src.entorno.single_agent import CorazonesEnv
        from sb3_contrib import MaskablePPO
...
class TestDeteccionVecNorm:
    ...
    def test_detectar_vecnorm_retorna_none_si_no_existe(self):
        ...
        from src.torneo.evaluacion import _detectar_vecnorm
        import tempfile
...
class TestCallbackEvaluacion:
    ...
    def test_guardar_log_evaluacion_crea_archivo(self):
        ...
        from src.torneo.evaluacion import _guardar_log_evaluacion
        with tempfile.TemporaryDirectory() as tmpdir:
